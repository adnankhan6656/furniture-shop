 ...
 const handlesidebar=()=>{
  ...
  backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url("https://websitedemos.net/home-decor-04/wp-content/uploads/sites/644/2020/08/furniture-store-hero-bg.jpg")'
   ...
   {/* Header Start */}
       ...
       <div className="flex items-center space-between  p-6  sm:p-4 justify-between border-gray-500 border-b-[0.1px]">
        ...
        {isvisible && (
            <ul className="flex flex-col items-center gap-4 rounded-br-lg rounded-bl-lg px-1 text-white bg-white text-black h-[250px] shadow-md absolute top-0 left-0 w-full  transition-all duration-300  z-10 sm:hidden">
              ...
              <li className="text-md mt-11 border-b-[1px] p-3 w-full">Home</li>
              <li className="text-md border-b-[1px] p-3 w-full">Products</li>
              <li className="text-md p-3 w-full">Sign-in</li>
            </ul>
          )}     
...
<RxHamburgerMenu/>
    ...
    {/* For Desktop navigation */}
       ...
       <li className="text-md cursor-pointer">Home</li>
              ...
              <li className="text-md cursor-pointer">Sign-in</li>
              <li>
